...
GAD_EXTERN GADNativeAppInstallAssetID const GADNativeAppInstallCallToActionAsset
    GAD_DEPRECATED_ATTRIBUTE;
GAD_EXTERN GADNativeAppInstallAssetID const GADNativeAppInstallIconAsset GAD_DEPRECATED_ATTRIBUTE;
GAD_EXTERN GADNativeAppInstallAssetID const GADNativeAppInstallBodyAsset GAD_DEPRECATED_ATTRIBUTE;
GAD_EXTERN GADNativeAppInstallAssetID const GADNativeAppInstallStoreAsset GAD_DEPRECATED_ATTRIBUTE;
GAD_EXTERN GADNativeAppInstallAssetID const GADNativeAppInstallPriceAsset GAD_DEPRECATED_ATTRIBUTE;
GAD_EXTERN GADNativeAppInstallAssetID const GADNativeAppInstallImageAsset GAD_DEPRECATED_ATTRIBUTE;
