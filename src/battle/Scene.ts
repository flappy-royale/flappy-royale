...
export class BattleScene extends Phaser.Scene {
    ...
    create() {
        ...
        this.anims.create({
            key: "ghostFlap",
            frames: [{ key: "ghostbird", frame: 0 }, { key: "ghostbird2", frame: 1 }, { key: "ghostbird3", frame: 2 }],
            frameRate: 8,
            repeat: -1
        });
    ...
    rotateSprite(sprite: Phaser.Physics.Arcade.Sprite) {
        if (sprite.body.velocity.y >= 100) sprite.play("dive");
