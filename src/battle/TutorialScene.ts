...
export class TutorialScene extends Phaser.Scene {
  ...
  userFlap() {
    ...
    if (this.bird.isInBus) {
      ...
      this.pipes.push(addRowOfPipesManual(250, this, constants.tutorialGapHeight, constants.tutorialGapSlot, this.theme))
      this.pipes.push(addRowOfPipesManual(280, this, constants.tutorialGapHeight, constants.tutorialGapSlot, this.theme))
      this.pipes.push(addRowOfPipesManual(310, this, constants.tutorialGapHeight, constants.tutorialGapSlot, this.theme))
      this.pipes.push(addRowOfPipesManual(340, this, constants.tutorialGapHeight, constants.tutorialGapSlot, this.theme))
      this.pipes.push(addRowOfPipesManual(370, this, constants.tutorialGapHeight, constants.tutorialGapSlot, this.theme))
  ...
  userScored(_bird: Phaser.GameObjects.Sprite, line: Phaser.Physics.Arcade.Sprite) {
    if (this.tutorialStep === TutorialStep.Flapping) {
      this.tutorialStep = TutorialStep.Name

      const name = prompt("Welcome to the Royale! What would you like to be called?")
      changeSettings({ name })

      const goToSettings = confirm("You can pick a fun outfit in the Settings! Go there now?")
  ...
  userDied() {
    if (this.tutorialStep === TutorialStep.Flapping) {
      ...
      setTimeout(() => { this.restartTheGame() }, 500)
    }
  }
